                    ...
                    <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 3 }}>
                        <Grid item xs={6} sm={6}>
                            <div className="creator_contain">
                                ...
                                <p className="creator_P">Serve The Community By Creating Relevont Video Content</p>
                            </div>
                        </Grid>
                        <Grid item xs={6} sm={6}>
                            <div className="creator_contain">
                                ...
                                <p className="creator_P">Be A Pillor In The Progress Of Gamers At Their Own Pace</p>
                            </div>
                        </Grid>
                        <Grid item xs={6} sm={6}>
                            <div className="creator_contain">
                                <div className="creator_img">
                                    <img src={Vector} alt="Group"
                                        className="creator_img_icon"
                                    />
                                </div>
                                <p className="creator_P">Listening To The Community About Their Needs </p>
                            </div>
                        </Grid>
                        <Grid item xs={6} sm={6}>
                            <div className="creator_contain">
                                ...
                                <p className="creator_P">Participate In The Moderation And Validtion Of Content</p>
                            </div>
                        </Grid>
                    </Grid>
                </div>
